...
const BookingCalendar: React.FC<BookingCalendarProps> = ({ fewoOwnID, lang }): JSX.Element => {
  ...
  // // Generate days based on calendarRange using your function
  // const days = useMemo(() => generateCalendarDays(calendarRange), [calendarRange]);

  // Calculate parsedStartDate from calendarRange.startDate
  // const parsedStartDate = parseISO(calendarRange.startDate);

  // Then calculate year using parsedStartDate
